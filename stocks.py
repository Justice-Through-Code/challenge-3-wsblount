...
def stock_purchases():
    ...
    savings = int(input('How much would you like to invest? $'))
    ...
    shares = int(savings / stock)

    print(f'{name} has ${savings} to invest and can buy {shares} shares of {stock_name} at the current price of ${stock}.')  
